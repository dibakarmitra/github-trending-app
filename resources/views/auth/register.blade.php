...
<div class="container">
    ...
    <div class="card">
        <article class="card-body">
            <a href="{{route('login')}}" class="float-right btn btn-outline-primary">Log in</a>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    <input class="form-control" placeholder="Your name" type="text" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus />
                    @error('name')
                ...
                <div class="form-group">
                    <input class="form-control" placeholder="confirm ******" type="password" name="password_confirmation" required autocomplete="new-password" />
                </div> <!-- form-group// -->
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
